<h2><a href="https://leetcode.com/problems/integer-to-roman/description/?envType=problem-list-v2&envId=math">12. Integer to Roman</a></h2><h3>Medium</h3><hr><p>Seven different symbols represent Roman numerals with the following values:</p>
